...
public class InitializedData {
    ...
    @Inject
    public InitializedData(TrainerService trainerService, TypeService typeService,
                           PokemonService pokemonService, RequestContextController requestContextController){
    ...
    private synchronized void init(){
        ...
        List<Pokemon> emptyPokemonList2 = new ArrayList<Pokemon>();
        List<Pokemon> emptyPokemonList3 = new ArrayList<Pokemon>();
